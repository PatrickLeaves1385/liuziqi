...
const BUILTIN_BOTS_JS = [
  'rules_metered.js', 'templates_factory.js', 'training_bots.js', 'builtins.js',
  'prisoner/rules.js', 'prisoner/training_bots.js',
].map((f) => fs.readFileSync(path.join(__dirname, 'engine', f), 'utf8')).join('\n;\n');
const db = require('./db');
